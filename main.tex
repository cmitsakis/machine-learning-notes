...
For two classes:
\[\begin{split}
	x \in \omega_1 &\Leftrightarrow P(\omega_1 \mid x) > P(\omega_2 \mid x) \\
	&\Leftrightarrow P(x \mid \omega_1)P(\omega_1) > P(x \mid \omega_2)P(\omega_2)
\end{split}\]
\[\begin{split}
	x \in \omega_2 &\Leftrightarrow P(\omega_1 \mid x) < P(\omega_2 \mid x) \\
	&\Leftrightarrow P(x \mid \omega_1)P(\omega_1) < P(x \mid \omega_2)P(\omega_2)
\end{split}\]

For many classes:
\[x \in \omega_i \Leftrightarrow P(\omega_i \mid x) > P(\omega_j \mid x),\ \forall j\ j \neq i\]
