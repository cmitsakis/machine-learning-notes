...
\[g_i(\symbf{x}) = -\frac{1}{2} (\symbf{x} - \symbf{\mu}_i)^T \symbf{\Sigma}_i^{-1} (\symbf{x} - \symbf{\mu}_i) - \frac{d}{2}\ln2\pi - \frac{1}{2} ln |\symbf{\Sigma}_i| + ln P(\omega_i)\]
...
\[g_i(\symbf{x}) = -\frac{1}{2} (\symbf{x} - \symbf{\mu}_i)^T \symbf{\Sigma}_i^{-1} (\symbf{x} - \symbf{\mu}_i) - \frac{d}{2}\ln2\pi + ln P(\omega_i)\]
\[g_i(\symbf{x}) = \symbf{w}_i^T \symbf{x} + w_{i0}\]
where:
